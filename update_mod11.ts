...
txt = txt.replace(/const lessonName = lessons\[offset\];/g, `const lessonMatch = lessons[offset].match(/^(.*?) (Matematik|Türkçe|Fen|İnk\\.Tar|İngilizce|Fen Bilg\\.|Din Kültürü|Sosyal Bilgiler|Fizik|Kimya|Biyoloji|Coğrafya|Tarih|Geometri)$/i);
